...
| **14** | **Actuators Diagnostics & Lock** | `WHO 14 Actuator Diagnostics` / `WHO_14.pdf` | v1.0.0 (2008) | 🔴 | Core diagnostics | Physical lock/unlock, diagnostic error codes, operating cycles counters. |
